...
class ThinLayerStrendaML(object):
    ...
    def exportEnzymeML(self, path, out_dir):
        ...
        self.enzmldoc.setUrl(f"StrendaID:{name}")
    ...
    def __getReactions(self, root):
        ...
        for i, dataset in enumerate(datasets):
            ...
            for model in kinetic_models:
                ...
                parameters[f'kcat_{sub_id}'] = ( float(kcat_val), kcat_unit )
                parameters[f'km_{sub_id}'] = ( float(km_val), km_unit )
    ...
    def __getProtein(self, root):
        ...
        for dataset in datasets:
            ...
            protein = Protein(
                f"{name} {init_conc} {substance_units}",
                sequence,
                "v0",
                init_conc,
                substance_units,
